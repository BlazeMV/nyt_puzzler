...
letter_boxed_bp = Blueprint('letter_boxed', __name__)
...
@letter_boxed_bp.route('/letter-boxed', methods=['GET', 'POST'])
def letter_boxed():
    ...
    return render_template('letter_boxed.html', solutions=None, side1=["", "", ""], side2=["", "", ""], side3=["", "", ""],
